          ...
          {loadingStats ? (
            ...
            <div className="overflow-x-auto -mx-4 scrollbar-hide">
              <div className="flex gap-3 pb-2 px-4">
                {stats?.todayBookings?.map((booking) => {
                  ...
                  return (
                    <Card 
                      ...
                      className={`p-3 w-[160px] h-[180px] shrink-0 transition-all cursor-pointer hover:scale-[1.02] active:scale-[0.98] ${isPast ? 'opacity-50' : ''} ${
                ...
                <Card 
                  className="p-3 w-[160px] h-[180px] shrink-0 flex flex-col items-center justify-center cursor-pointer hover:bg-muted/50 transition-colors border-dashed border-2"
                  onClick={() => openNewBooking()}
                >
